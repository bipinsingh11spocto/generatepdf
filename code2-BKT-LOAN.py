...
# bk1 dln 
    ...
    db_to_placeholder_mapping = {
        ...
        "customerid": "CRN",
        "recommendation1": "Loan_Accout_No. / Credit_Card_No.",

        "payment_date": "O/s Status Date (TOS / OD)",
    ...
    try:
        ...
        cursor.execute("SELECT * FROM sp_leads where batch_no=9180")
...
# """)
        ...
        #     # print(record)
        html_file_path = "BKT-Loan/BKTLoan.html"
        ...
        for record in records:
            ...
            file_name = f"BKT-Loan/modified_file_{record_dict['id']}.html"
            with open(file_name, "w", encoding="utf-8") as file:
                file.write(modified_html_content)
            print("All placeholders updated successfully!")

            input_html = f'BKT-Loan/modified_file_{record_dict['id']}.html'
