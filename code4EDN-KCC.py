...
# """)
        ...
        #     # print(record)
        html_file_path = "EDN-KCC/EDNKCC.html"
        ...
        for record in records:
            ...
            placeholders = {placeholder: "empty" for placeholder in db_to_placeholder_mapping.values()}
            ...
            for db_column, placeholder in db_to_placeholder_mapping.items():
                if db_column in record_dict:
                    ...
                    if isinstance(value, datetime):
                        value = value.strftime("%Y-%m-%d")  # Format datetime as 'YYYY-MM-DD'
            ...
            file_name = f"EDN-KCC/modified_file_{record_dict['id']}.html"
            with open(file_name, "w", encoding="utf-8") as file:
                file.write(modified_html_content)
            print("All placeholders updated successfully!")

            input_html = f'EDN-KCC/modified_file_{record_dict['id']}.html'
